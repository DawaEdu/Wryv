...
#include "UIActionCommand.generated.h"
...
class WRYV_API UUIActionCommand : public UObject
{
  GENERATED_BODY()
public:
  ...
  // Every UUIActionCommand + Derivative has a cooldown counter,
  ...
  // his list of items).
  int UUICmdActionIndex;
  // The cooldown clock associated with this icon.
  Clock* clock;

  UUIActionCommand( const FObjectInitializer & PCIP );
