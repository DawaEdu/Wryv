...
public:
  // These are the units capabilities. Spells are multi-use abilities, ie reusable.
  UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=UnitProperties)  TArray< TEnumAsByte< Types > > Spells;
