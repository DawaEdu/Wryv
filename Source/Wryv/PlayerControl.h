...
public:
  ...
  vector<AGameObject*> FrustumPick( const FBox2DU& box, set<Types> AcceptedTypes, set<Types> NotTypes );
  ...
  vector<AGameObject*> ComponentPickExcept( AGameObject* object, UPrimitiveComponent* up, vector<AGameObject*> except,
