...
class UUIInProgressUnit;
class UUIInProgressResearch;
class AUnit;
...
public:
  ...
  UPROPERTY() TArray< UUIInProgressUnit* > CountersUnitsInProgress;
  UPROPERTY() TArray< UUIResearchCommand* > ResearchesAvailable;  // Research kick-off buttons.
  UPROPERTY() TArray< UUIInProgressResearch* > CountersResearchInProgress; // Cancellable, started researches.
  ...
  void ReleaseUnit( UUIInProgressUnit* unit );
